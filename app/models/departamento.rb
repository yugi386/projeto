class Departamento < ActiveRecord::Base
	...
	# default_scope order('departamentos.destaque DESC', 'departamentos.nome ASC')	# ordem de listagem dos departamentos.
	default_scope order('upper(departamentos.nome) ASC') 	# ordem de listagem dos departamentos.
	...
	# ValidaCAO do Nome:
	validates_presence_of  :nome, :message => "do Departamento deve ser preenchido!"
	...
	# Verifica se o departamento está cadastrado considerando maiusculas e minusculas como iguais...
